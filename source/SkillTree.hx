...
class SkillTree
{
	...
	**/
	...
	public function new()
	{
		...
		currentNode = new SkillTreeNode(0, 1, 5, 0, new Tooltip("Deflection", "Increases your parry chance by 1%."));
		nodes.add(currentNode);
		nodeMap["Deflection"] = currentNode;

		currentNode = new SkillTreeNode(0, 2, 3, 0, new Tooltip("Improved Rend", "Increases the bleed damage done by your Rend ability by 15%."));
		nodes.add(currentNode);
		nodeMap["Improved Rend"] = currentNode;

		// ---

		currentNode = new SkillTreeNode(1, 0, 2, 5, new Tooltip("Improved Charge", "Increases the amount of rage generated by your Charge ability by 3."));
		nodes.add(currentNode);
		nodeMap["Improved Charge"] = currentNode;

		currentNode = new SkillTreeNode(1, 1, 5, 5, new Tooltip("Tactical Mastery", "You retain up to 5 of your rage points when you change stances."));
		nodes.add(currentNode);
		nodeMap["Tactical Mastery"] = currentNode;

		currentNode = new SkillTreeNode(1, 3, 3, 5,
		...
		currentNode = new SkillTreeNode(2, 0, 2, 10,
		...
		currentNode = new SkillTreeNode(3, 1, 5, 15,
		...
		currentNode = new SkillTreeNode(4, 0, 5, 20, new Tooltip("Axe Specialization", "Increases your chance to get a critical strike with Axes by 1%."));
		nodes.add(currentNode);
		nodeMap["Axe Specialization"] = currentNode;

		currentNode = new SkillTreeNode(4, 1, 1, 20, new Tooltip("Sweeping Strikes", "Your next 5 melee attacks strike an additional nearby opponent."));
		nodes.add(currentNode);
		nodeMap["Sweeping Strikes"] = currentNode;

		currentNode = new SkillTreeNode(4, 2, 5, 20, new Tooltip("Mace Specialization", "Gives you a 1% chance to stun your target for 3 sec with a Mace."));
		nodes.add(currentNode);
		nodeMap["Mace Specialization"] = currentNode;

		currentNode = new SkillTreeNode(4, 3, 5, 20,
		...
		currentNode = new SkillTreeNode(5, 0, 5, 25,
		...
		currentNode = new SkillTreeNode(5, 2, 3, 25,
